...
//        add_action('wp_ajax_plugin_run_two_get-fluentform-forms', array($this, 'getFluentformForms'));
//        add_action('wp_ajax_plugin_run_two_get-fluentform-fields', array($this, 'getFluentformFields'));
//        add_action('wp_ajax_plugin_run_two_save_fluentform_table', array($this, 'saveTable'), 10, 1);
//
