    ...
    <div class="plugin_run_one_card">
        ...
        <div class="nav">
            <ul class="cc-inline-list">
                ...
                <router-link tag="li" v-for="menuItem in topMenus" :key="menuItem.route" active-class="ninja-tab-active" exact :class="['ninja-tab el-menu-item']" :to="{ name: menuItem.route }">
